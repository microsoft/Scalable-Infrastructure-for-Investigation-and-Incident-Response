...
$FileName = #Name of the Script to call "2a. WindowsUpdate.ps1"
$extentionName = #Name for the Custom Script extension, has to be the same in the variables for "3. Invoke Sysprep"
#############################################################################################
